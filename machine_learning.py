...
iowa_file_path = 'C:\Users\natha\OneDrive - University of Essex\Team Project\home-data-for-ml-course'
...
predicted_home_prices_1 = iowa_model.predict(val_X.head())
for p in predicted_home_prices_1:
    print(p)
print()
...
predicted_home_prices_2 = iowa_model.predict(val_X)
print("The mean absolute error in the house prices is: " + str(mean_absolute_error(val_y, predicted_home_prices_2)))